 ...
 *
 * Description: If the file is not an ELF - then exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int i;
...
/**
 * print_magic - Prints magic numbers of ELF header file.
...
/**
 * print_osabi - Prints the OS/ABI of ELF header file.
 * @e_ident: Pointer to an array that contains the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
